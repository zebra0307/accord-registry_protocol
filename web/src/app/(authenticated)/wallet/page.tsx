        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Please connect your wallet to view your credits.</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/20 border border-emerald-500/30 rounded-2xl p-8 mb-8">
                    <div className="flex items-start justify-between">
                        <div>
                            ...
                            <div className="text-5xl font-bold text-gray-900 dark:text-white mb-2">
                                {creditBalance.toLocaleString()} <span className="text-2xl text-gray-600 dark:text-gray-400">ACCORD</span>
                            </div>
                    ...
                    <div className="mt-8 grid grid-cols-3 gap-6 pt-6 border-t border-emerald-500/20">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">{totalRetired}</p>
                        </div>
                        <div>
                            <p className="text-gray-600 dark:text-gray-400 text-sm">Impact (CO2)</p>
                        ...
                        <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">3 NFTs</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/50 rounded-xl">
                        ...
                        <div className="divide-y divide-gray-200 dark:divide-gray-700/50">
                            {[
                                ...
                                <div key={holding.projectId} className="p-6 hover:bg-gray-200 dark:hover:bg-gray-700/20 transition-colors">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h3 className="font-semibold text-gray-900 dark:text-white">{holding.name}</h3>
                                            <p className="text-sm text-gray-600 dark:text-gray-400">{holding.projectId} • Vintage {holding.vintage}</p>
                                        </div>
                                        <div className="text-right">
                                            <div className="text-xl font-bold text-gray-900 dark:text-white">{holding.balance.toLocaleString()}</div>
                                            <div className="text-sm text-gray-600 dark:text-gray-400">ACCORD</div>
                                        </div>
                                    </div>
                                </div>
                            ))}
                ...
                <div className="mt-8 grid grid-cols-2 gap-6">
                    <Link
                        ...
                        className="p-6 bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/50 rounded-xl hover:border-emerald-500/30 transition-colors group text-center"
                    >
