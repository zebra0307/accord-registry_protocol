        ...
        <div className="min-h-screen py-12">
            <div className="max-w-lg mx-auto px-4">
                ...
                <div className="bg-gray-800/50 border border-gray-700/50 rounded-2xl p-6">
                    ...
                    <div className="mb-4">
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-sm text-gray-400">{pool.creditMint}</span>
                        ...
                        <div className="flex items-center bg-gray-900 rounded-xl p-4">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <div className="flex items-center space-x-2 px-3 py-2 bg-gray-700 rounded-lg">
                                    ...
                                    <span className="text-white font-medium">{pool.creditMint}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center -my-2 relative z-10">
                        <div className="w-10 h-10 bg-gray-700 border-4 border-gray-800 rounded-xl flex items-center justify-center text-gray-400">
                            +
                        </div>
                    </div>
                    ...
                    <div className="mt-4">
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-sm text-gray-400">{pool.quoteMint}</span>
                            <span className="text-sm text-gray-400">
                        ...
                        <div className="flex items-center bg-gray-900 rounded-xl p-4">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <div className="flex items-center space-x-2 px-3 py-2 bg-gray-700 rounded-lg">
                                    ...
                                    <span className="text-white font-medium">{pool.quoteMint}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {creditAmount && quoteAmount && parseFloat(creditAmount) > 0 && (
                        <div className="mt-6 p-4 bg-gray-900/50 rounded-xl space-y-3">
                            ...
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <span className="text-white">{lpTokensToReceive} LP</span>
                            </div>
                            <div className="flex items-center justify-between text-sm">
                    ...
                    <button
                        ...
                        className="w-full mt-6 py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl text-white font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90 transition-opacity"
                    >
                ...
                <div className="mt-6 bg-gray-800/50 border border-gray-700/50 rounded-xl p-6">
                    <h3 className="font-semibold text-white mb-4">Current Pool Stats</h3>
                    <div className="grid grid-cols-2 gap-4 text-sm">
                        <div className="p-3 bg-gray-900/50 rounded-lg">
                            <div className="text-gray-400">Credit Reserve</div>
                            <div className="font-semibold text-white">{pool.creditReserve.toLocaleString()} {pool.creditMint}</div>
                        </div>
                        <div className="p-3 bg-gray-900/50 rounded-lg">
                            <div className="text-gray-400">Quote Reserve</div>
                            <div className="font-semibold text-white">${pool.quoteReserve.toLocaleString()}</div>
                        </div>
                        <div className="p-3 bg-gray-900/50 rounded-lg">
                            <div className="text-gray-400">Total LP Supply</div>
                            <div className="font-semibold text-white">{pool.totalLpTokens.toLocaleString()}</div>
                        </div>
                        <div className="p-3 bg-gray-900/50 rounded-lg">
                            <div className="text-gray-400">Fee Tier</div>
                            <div className="font-semibold text-white">{pool.feeBps / 100}%</div>
                        </div>
                    </div>
                </div>
            </div>
