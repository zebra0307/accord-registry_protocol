            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <h1 className="text-3xl font-bold text-white mt-2">My LP Positions</h1>
                        <p className="text-gray-400 mt-1">Manage your liquidity provider positions</p>
                    </div>
                    <Link
                        href="/dex/pools"
                        className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl text-white font-semibold hover:opacity-90"
                    >
                        + Add Liquidity
                    </Link>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/30 rounded-xl p-6">
                        ...
                        <div className="text-3xl font-bold text-white">${totalValueLocked.toLocaleString()}</div>
                    </div>
                    <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 rounded-xl p-6">
                        <div className="text-sm text-gray-400 mb-1">Total Fees Earned</div>
                    ...
                    <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-6">
                        ...
                        <div className="text-3xl font-bold text-white">{MOCK_POSITIONS.length}</div>
                    </div>
                </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="flex items-center space-x-8">
                                        ...
                                        <span className={`text-gray-400 transition-transform ${expandedPosition === position.id ? "rotate-180" : ""
                                            }`}>
                                            ▼
                                        </span>
                                    </div>
                                    ...
                                    <div className="px-6 pb-6 border-t border-gray-700/50">
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-4">
                                            <div className="p-4 bg-gray-900/50 rounded-xl">
                                                <div className="text-sm text-gray-400">ACCORD Deposited</div>
                                                <div className="font-semibold text-white">{position.creditDeposited.toLocaleString()}</div>
                                            ...
                                            <div className="p-4 bg-gray-900/50 rounded-xl">
                                                <div className="text-sm text-gray-400">Fees Earned (ACCORD)</div>
                                                <div className="font-semibold text-emerald-400">
                ...
                <div className="mt-8 p-6 bg-purple-500/10 border border-purple-500/30 rounded-xl">
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 className="font-semibold text-white mb-2">Understanding LP Positions</h3>
