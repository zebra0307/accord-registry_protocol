                        ...
                        <div className="bg-gray-800/50 border border-gray-700/50 rounded-2xl p-6">
                            ...
                            <div className="mb-2">
                                ...
                                <div className="flex items-center bg-gray-900 rounded-xl p-4">
                                    ...
                                    <button className="flex items-center space-x-2 px-4 py-2 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors">
                                        <div className={`w-6 h-6 rounded-full flex items-center justify-center font-bold text-xs ${fromToken === "CARBON" ? "bg-emerald-500 text-white" : "bg-purple-500 text-white"
                                            }`}>
                                            {fromToken === "CARBON" ? "C" : "◎"}
                                        </div>
                            ...
                            <div className="mt-2">
                                ...
                                <div className="flex items-center bg-gray-900 rounded-xl p-4">
                                    ...
                                    />
                                    <button className="flex items-center space-x-2 px-4 py-2 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors">
                                        <div className={`w-6 h-6 rounded-full flex items-center justify-center font-bold text-xs ${toToken === "CARBON" ? "bg-emerald-500 text-white" : "bg-purple-500 text-white"
                                            }`}>
                                            {toToken === "CARBON" ? "C" : "◎"}
                                        </div>
