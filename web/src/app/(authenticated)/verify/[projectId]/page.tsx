        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-400">Please connect your wallet as a validator to verify projects.</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center justify-between mt-4">
                        <div>
                            <h1 className="text-3xl font-bold text-white">Verify Project</h1>
                            <p className="text-gray-400 mt-1">{projectId}</p>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="font-medium text-white capitalize">{project.sector}</div>
                                </div>
                                <div>
                                    <div className="text-sm text-gray-400">Location</div>
                                    <div className="font-medium text-white">{project.location.regionName}, {project.location.countryCode}</div>
                                </div>
                                <div>
                                    <div className="text-sm text-gray-400">Area</div>
                                    <div className="font-medium text-white">{project.areaHectares} hectares</div>
                                </div>
                                <div>
                                    <div className="text-sm text-gray-400">Estimated Carbon</div>
                                    <div className="font-medium text-white">{project.carbonTonsEstimated.toLocaleString()} tCO2e</div>
                                </div>
                                <div>
                                    <div className="text-sm text-gray-400">Vintage Year</div>
                                    <div className="font-medium text-white">{project.vintageYear}</div>
                                </div>
                            </div>
                        ...
                        <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-6">
                            <h2 className="text-lg font-semibold text-white mb-4">DePIN Monitoring Data</h2>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                                <div className="p-4 bg-gray-900/50 rounded-xl text-center">
                                    <div className="text-2xl mb-2">🛰️</div>
                                    <div className="text-sm text-gray-400">NDVI Index</div>
                                        ...
                                        <div className="space-y-2">
                                            {VERIFICATION_CHECKLIST.filter(item => item.category === category).map((item) => (
                                                ...
                                                >
                                                    ...
                                                    <span className={checklist[item.id] ? "text-white" : "text-gray-300"}>
                                                        {item.label}
                                                    </span>
                                                </label>
                                            ))}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-6">
                            <h2 className="text-lg font-semibold text-white mb-4">Verification Decision</h2>
                            ...
                            <div className="mb-4">
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    className="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-white focus:outline-none focus:border-emerald-500 resize-none"
                                />
                            </div>
                            ...
                            {decision === "reject" && (
                                <div className="mt-4">
                                    ...
                                    <textarea
                                        ...
                                        rows={3}
                                        className="w-full px-4 py-3 bg-gray-900 border border-red-500/30 rounded-xl text-white focus:outline-none focus:border-red-500 resize-none"
                                    />
                                </div>
                            )}
                            ...
                            {decision && (
                                <button
                                    ...
                                    className="w-full mt-4 py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl text-white font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                        ...
                        <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-6">
                            <div className="flex items-center space-x-3 mb-2">
                                ...
                                <h3 className="font-semibold text-white">Verification Reward</h3>
                            </div>
