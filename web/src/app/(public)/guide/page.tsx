            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                    {[
                        ...
                        <a
                            key={item.href}
                            href={item.href}
                            className="p-4 bg-gray-800/50 border border-gray-700/50 rounded-xl text-center hover:border-emerald-500/30 transition-colors"
                        >
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="text-left border-b border-gray-700">
                                        ...
                                        <th className="pb-3 text-gray-400 text-center">User</th>
                                        <th className="pb-3 text-gray-400 text-center">Validator</th>
                                        <th className="pb-3 text-gray-400 text-center">Government</th>
                                        <th className="pb-3 text-gray-400 text-center">Admin</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-700/50">
                                    <tr>
                                        <td className="py-3 text-white">Buy credits on Marketplace</td>
                                    ...
                                    <tr>
                                        <td className="py-3 text-white">Sell own credits</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                    ...
                                    <tr>
                                        <td className="py-3 text-white">Swap on DEX</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                    ...
                                    <tr>
                                        <td className="py-3 text-white">Add Liquidity to Pools</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                    ...
                                    <tr>
                                        <td className="py-3 text-white">Retire credits for offset</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                                    ...
                                    <tr>
                                        <td className="py-3 text-white">Register projects</td>
                                        <td className="py-3 text-center text-emerald-400">✓</td>
                ...
                <section id="governance" className="mb-16">
                    ...
                    <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-6 mb-6">
                        <h3 className="font-semibold text-white mb-4">How Proposals Work</h3>
                        <div className="grid md:grid-cols-4 gap-4">
                            <div className="text-center">
                                ...
                                <div className="text-sm text-white font-medium">Create</div>
                                <p className="text-xs text-gray-400">Admin creates proposal</p>
                            </div>
                            <div className="text-center">
                                <div className="w-12 h-12 bg-purple-500/10 rounded-full flex items-center justify-center text-2xl mx-auto mb-2">2</div>
                                <div className="text-sm text-white font-medium">Vote</div>
                                <p className="text-xs text-gray-400">Other admins approve</p>
                            </div>
                            <div className="text-center">
                                <div className="w-12 h-12 bg-purple-500/10 rounded-full flex items-center justify-center text-2xl mx-auto mb-2">3</div>
                                <div className="text-sm text-white font-medium">Threshold</div>
                                <p className="text-xs text-gray-400">2 of 3 required</p>
                            </div>
                            <div className="text-center">
                                <div className="w-12 h-12 bg-emerald-500/10 rounded-full flex items-center justify-center text-2xl mx-auto mb-2">✓</div>
                                <div className="text-sm text-white font-medium">Execute</div>
                                <p className="text-xs text-gray-400">Action takes effect</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-6">
                            <h3 className="font-semibold text-white mb-4">Proposal Types</h3>
                        ...
                        <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="text-white font-medium">2 of 3</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-gray-400">Emergency Admin</span>
                ...
                <section id="lifecycle" className="mb-16">
                    ...
                    <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-6">
                        <div className="flex flex-wrap justify-center gap-2 items-center">
                            <div className="p-4 bg-gray-900/50 rounded-xl text-center min-w-[120px]">
                            ...
                            <div className="p-4 bg-gray-900/50 rounded-xl text-center min-w-[120px]">
                                <div className="text-2xl mb-1">🔍</div>
                                <div className="text-sm text-white">Verify</div>
                                <div className="text-xs text-blue-400">Validator</div>
                            </div>
                            <div className="text-gray-600">→</div>
                            <div className="p-4 bg-gray-900/50 rounded-xl text-center min-w-[120px]">
                                <div className="text-2xl mb-1">🏛️</div>
                                <div className="text-sm text-white">LoA</div>
                                <div className="text-xs text-purple-400">Government</div>
                            </div>
                            <div className="text-gray-600">→</div>
                            <div className="p-4 bg-gray-900/50 rounded-xl text-center min-w-[120px]">
                                <div className="text-2xl mb-1">🪙</div>
                                <div className="text-sm text-white">Mint</div>
                                <div className="text-xs text-gray-400">Automatic</div>
                            </div>
                            <div className="text-gray-600">→</div>
                            <div className="p-4 bg-gray-900/50 rounded-xl text-center min-w-[120px]">
                                <div className="text-2xl mb-1">💱</div>
                                <div className="text-sm text-white">Trade</div>
                                <div className="text-xs text-gray-400">Anyone</div>
                            </div>
                            <div className="text-gray-600">→</div>
                            <div className="p-4 bg-gray-900/50 rounded-xl text-center min-w-[120px]">
                                <div className="text-2xl mb-1">🔥</div>
                                <div className="text-sm text-white">Retire</div>
